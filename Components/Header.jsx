...
// import weldingLogo from '../src/assets/weldingLogo.png' // Adjust path as necessary
...
function Header({ aboutPage, contactPage, setAboutPage, setContactPage, setHomePage }) {
        ...
        >
          <Container maxWidth="lg">
            ...
            >
              ...
              >
                <img
                  src={weldingLogo} // Replace with your actual logo URL or import path
                  style={logoStyle}
                  alt="logo of welding"
                />
                <Box sx={{ display: { xs: 'none', md: 'flex' }, marginLeft: '30vw' }}>
                  <MenuItem onClick={() => togglePage('home')} sx={{ py: '6px', px: '12px' }}>
                    <Typography variant="body2" color="#000" fontSize={18}>
                      Home
                    </Typography>
                  </MenuItem>
                  ...
                  <MenuItem onClick={() => togglePage('about')} sx={{ py: '6px', px: '12px' }}>
                    <Typography variant="body2" color="#000" fontSize={18}>
                      About Us
                    </Typography>
                  </MenuItem>
                  ...
                  <MenuItem onClick={() => togglePage('contact')} sx={{ py: '6px', px: '12px' }}>
                    <Typography variant="body2" color="#000" fontSize={18}>
                      Contact
                    </Typography>
                  </MenuItem>
